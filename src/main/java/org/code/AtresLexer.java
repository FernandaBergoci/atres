...
public class AtresLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"PROGRAMA", "INICIO", "INTEIRO", "RACIONAL", "STRING", "BOOLEAN", "TIPO", 
			"ESCREVA", "ENTRADA", "DECLARAR", "SE", "SENAO", "WHILE", "FOR", "FIM", 
			"STRING_DEF", "INTEIRO_DEF", "RACIONAL_DEF", "BOOLEAN_DEF", "OP_ATRIB", 
			"OP_SOMA", "OP_SUB", "OP_MULT", "OP_DIV", "BOOL_E", "BOOL_OU", "OP_RELAC", 
			"AB_PAR", "FC_PAR", "AB_CHAVE", "FC_CHAVE", "PV", "COMENTARIO", "ID", 
			"NUM_INT", "NUM_REAL", "WS"
		};
	}
	...
	public AtresLexer(CharStream input) {
		super(input);
